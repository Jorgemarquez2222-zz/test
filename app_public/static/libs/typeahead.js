        ...
        _.mixin(Menu.prototype, EventEmitter, {
            ...
            update: function update(query) {
                ...
                function updateDataset(dataset) {
                	if(dataset.name==='result'){
                		dataset.update(query);
                	}else if(dataset.name==='result1' && (query.length>=3)){
                		dataset.update(query);
                	}else if(dataset.name==='result2' && (query.length>=3)){
                		dataset.update(query);
                	}
    ...
    var Typeahead = function() {
        ...
        _.mixin(Typeahead.prototype, {
            ...
            _onEnterKeyed: function onEnterKeyed(type, $e) {
                ...
                if ($selectable = this.menu.getActiveSelectable()) {
                    if (this.select($selectable)) {
                    	$e.preventDefault();
                        $e.stopPropagation();
                    	if($selectable.children("a").children('#urlinp').val()){
                    		window.location.href=$selectable.children("a").children('#urlinp').val();
                    	}
            ...
            _minLengthMet: function minLengthMet(query) {
                ...
                return query.length >= this.minLength || query.length===0;
            },
